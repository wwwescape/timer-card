...
import { TimerCardConfig, ValueChangedEvent } from "./types/timer-card-types";

@customElement(CARD_EDITOR_NAME)
export class FormulaOneCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @state() private config?: TimerCardConfig;
  ...
  get _reverse(): boolean {
    return typeof this.config?.reverse === 'undefined' ? false : this.config?.reverse;
  }
